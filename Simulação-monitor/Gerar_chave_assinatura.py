...
diretorio = "/home/openran-br/xapp-workshop/exercise-xapps/xapp-2-sdl"
...
exportar_chave_publica(public_key, "/home/openran-br/xapp-workshop/exercise-xapps/assigned-xapps/chave_publica_sdl.pem")
comando = ["chmod", "-R", "440", "/home/openran-br/xapp-workshop/exercise-xapps/assigned-xapps/chave_publica_sdl.pem"]
subprocess.run(comando, check=True)

exportar_assinatura(assinatura, "/home/openran-br/xapp-workshop/exercise-xapps/assigned-xapps/assinatura_sdl.bin")
comando = ["chmod", "-R", "440", "/home/openran-br/xapp-workshop/exercise-xapps/assigned-xapps/assinatura_sdl.bin"]
subprocess.run(comando, check=True)
